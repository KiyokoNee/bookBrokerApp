...
public class UserController {
	...
	public String dashboard(HttpSession session, Model model) {
		...
		List<Book> borrowedBooks = bookServ.booksByBorrower(userId);
		
		model.addAttribute("username", user.getUsername());
		model.addAttribute("books", books);
		model.addAttribute("borrowed", borrowedBooks);
	...
	public String bookDetails(HttpSession session, Model model, @PathVariable Long id) {
		// Make sure people have to log in to see the books
		if(session.getAttribute("userId") == null)
			return "redirect:/";
		...
		// Set up conditional information based on whether the user owns the book or not
		boolean isUser = session.getAttribute("userId").equals(book.getUser().getId());
		model.addAttribute("isUser", isUser);
		model.addAttribute("reader", isUser ? "You" : book.getUser().getUsername());
		model.addAttribute("thinker", isUser ? "your" : book.getUser().getUsername() + "'s");
	...
	public String borrowBook(HttpSession session, @PathVariable Long id) {
